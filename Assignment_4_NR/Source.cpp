...
int main()
{
	...
	const std::vector <int> Ext = { 40}; //initializing the number of grid points along each dimension {t,x}
	...
	{
		Euler.Take_time_step_Lax_Wendroff(t_0, dx, dt, U, RhsComp, Method);
